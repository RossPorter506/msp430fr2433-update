...
pub type P3SEL1_0_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_0` writer - P3SEL1_0"]
pub type P3SEL1_0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_1` reader - P3SEL1_1"]
pub type P3SEL1_1_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_1` writer - P3SEL1_1"]
pub type P3SEL1_1_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_2` reader - P3SEL1_2"]
pub type P3SEL1_2_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_2` writer - P3SEL1_2"]
pub type P3SEL1_2_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_3` reader - P3SEL1_3"]
pub type P3SEL1_3_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_3` writer - P3SEL1_3"]
pub type P3SEL1_3_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_4` reader - P3SEL1_4"]
pub type P3SEL1_4_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_4` writer - P3SEL1_4"]
pub type P3SEL1_4_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_5` reader - P3SEL1_5"]
pub type P3SEL1_5_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_5` writer - P3SEL1_5"]
pub type P3SEL1_5_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_6` reader - P3SEL1_6"]
pub type P3SEL1_6_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_6` writer - P3SEL1_6"]
pub type P3SEL1_6_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
#[doc = "Field `P3SEL1_7` reader - P3SEL1_7"]
pub type P3SEL1_7_R = crate::BitReader<bool>;
#[doc = "Field `P3SEL1_7` writer - P3SEL1_7"]
pub type P3SEL1_7_W<'a, const O: u8> = crate::BitWriter<'a, u8, P3SEL1_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - P3SEL1_0"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - P3SEL1_0"]
    #[inline(always)]
    pub fn p3sel1_0(&mut self) -> P3SEL1_0_W<0> {
        P3SEL1_0_W::new(self)
    }
    #[doc = "Bit 1 - P3SEL1_1"]
    #[inline(always)]
    pub fn p3sel1_1(&mut self) -> P3SEL1_1_W<1> {
        P3SEL1_1_W::new(self)
    }
    #[doc = "Bit 2 - P3SEL1_2"]
    #[inline(always)]
    pub fn p3sel1_2(&mut self) -> P3SEL1_2_W<2> {
        P3SEL1_2_W::new(self)
    }
    #[doc = "Bit 3 - P3SEL1_3"]
    #[inline(always)]
    pub fn p3sel1_3(&mut self) -> P3SEL1_3_W<3> {
        P3SEL1_3_W::new(self)
    }
    #[doc = "Bit 4 - P3SEL1_4"]
    #[inline(always)]
    pub fn p3sel1_4(&mut self) -> P3SEL1_4_W<4> {
        P3SEL1_4_W::new(self)
    }
    #[doc = "Bit 5 - P3SEL1_5"]
    #[inline(always)]
    pub fn p3sel1_5(&mut self) -> P3SEL1_5_W<5> {
        P3SEL1_5_W::new(self)
    }
    #[doc = "Bit 6 - P3SEL1_6"]
    #[inline(always)]
    pub fn p3sel1_6(&mut self) -> P3SEL1_6_W<6> {
        P3SEL1_6_W::new(self)
    }
    #[doc = "Bit 7 - P3SEL1_7"]
    #[inline(always)]
    pub fn p3sel1_7(&mut self) -> P3SEL1_7_W<7> {
        P3SEL1_7_W::new(self)
    }
