...
pub type P1IV_R = crate::FieldReader<u16, P1IV_A>;
#[doc = "P1IV\n\nValue on reset: 0"]
...
pub type P1IV_W<'a, const O: u8> = crate::FieldWriter<'a, u16, P1IV_SPEC, u16, P1IV_A, 16, O>;
impl<'a, const O: u8> P1IV_W<'a, O> {
...
impl R {
    ...
    pub fn p1iv(&self) -> P1IV_R {
        P1IV_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - P1IV"]
    #[inline(always)]
    pub fn p1iv(&mut self) -> P1IV_W<0> {
        P1IV_W::new(self)
    }
