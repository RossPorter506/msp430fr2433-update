...
pub type P2IV_R = crate::FieldReader<u16, P2IV_A>;
#[doc = "P2IV\n\nValue on reset: 0"]
...
pub type P2IV_W<'a, const O: u8> = crate::FieldWriter<'a, u16, P2IV_SPEC, u16, P2IV_A, 16, O>;
impl<'a, const O: u8> P2IV_W<'a, O> {
...
impl R {
    ...
    pub fn p2iv(&self) -> P2IV_R {
        P2IV_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - P2IV"]
    #[inline(always)]
    pub fn p2iv(&mut self) -> P2IV_W<0> {
        P2IV_W::new(self)
    }
